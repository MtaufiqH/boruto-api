...
class HeroRepositoryImpl : HeroRepository {
    ...
    override val page1 = listOf(
        Hero(
            id = 1,
            name = "Sasuke",
            image = "/boruto/images/sasuke.jpg",
        ...
        Hero(
            id = 2,
            name = "Naruto",
            image = "/boruto/images/naruto.jpg",
        ...
        Hero(
            id = 3,
            name = "Sakura",
            image = "/boruto/images/sakura.jpg",
    ...
    override val page2 = listOf(
        Hero(
            id = 4,
            name = "Boruto",
            image = "/boruto/images/boruto.png",
        ...
        Hero(
            id = 5,
            name = "Sarada",
            image = "/boruto/images/sarada.jpg",
        ...
        Hero(
            id = 6,
            name = "Mitsuki",
            image = "/boruto/images/mitsuki.jpg",
    ...
    override val page3 = listOf(
        Hero(
            id = 7,
            name = "Kawaki",
            image = "/boruto/images/kawaki.jpg",
        ...
        Hero(
            id = 8,
            name = "Orochimaru",
            image = "/boruto/images/orochimaru.jpg",
        ...
        Hero(
            id = 9,
            name = "Kakashi",
            image = "/boruto/images/kakashi.png",
    ...
    override val page4 = listOf(
        Hero(
            id = 10,
            name = "Isshiki",
            image = "/boruto/images/ishiki.jpg",
        ...
        Hero(
            id = 11,
            name = "Momoshiki",
            image = "/boruto/images/momoshiki.jpg",
        ...
        Hero(
            id = 12,
            name = "Urashiki",
            image = "/boruto/images/urashiki.jpg",
    ...
    private fun selectedHero(name: String): List<Hero> {
        require(name.isNotEmpty()) { "query is empty" }

        return heroes.flatMap { (_, heroes) ->
            heroes.filter { it.name.contains(name, ignoreCase = true) }
        }
    }
